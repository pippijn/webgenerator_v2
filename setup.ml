...
(* OASIS_START *)
(* DO NOT EDIT (digest: 5d3dfdca5beb511d948e4a577ac33010) *)
(*
...
let setup_t =
  {
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "drelex.ml"});
               Library
                 ({
                     cs_name = "webgen";
                     cs_data = PropList.Data.create ();
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Pod"; "PodLexer"; "PodParser"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_compiled_object = Byte;
                      bs_build_depends =
                        [InternalLibrary "webgen"; InternalLibrary "parsers"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
     ...
     oasis_version = "0.4.3";
     oasis_digest = Some "S\031\165\1716\203\1566\021\130\204jOL\246\166";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
